...
export const Navbar = () => {
  return (
    <div className="flex flex-row justify-center w-fit">
      ...
      />
      <div className="">
      <div className="flex bg-stone-700 mt-6 h-[85px] items-center justify-start md:justify-between rounded-lg shadow-[0px_5px_15px_rgba(0,0,0,0.35),5px_10px_15px_rgba(0,0,5,0.5)]">
